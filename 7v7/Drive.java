...
if(d.equals("1")){
//little easter egg here... if the number one receiver is juiced, it is an automatic big play regardless of odds
  int juicedReceiver = ((int)(Math.random()*5) +1);
  //random number that determines outcome of play
  int deepProb = ((int)(Math.random()*100) +1);
      
      System.out.println("Which receiver should we target?\n1." + a.roster()[1].getName() +"\n2." + a.roster()[2].getName() + "\n3." + a.roster()[3].getName() +"\n4." + a.roster()[4].getName() +"\n5."+ a.roster()[5].getName());

  //notifies  player of "juiced receiver" 
      if(juicedReceiver == 1){
         System.out.println("(Just got word from the offensive coordinator... " + a.roster()[juicedReceiver].getName() + " likes his matchup...)");
      }
     
   int e = in.nextInt();
   System.out.println(deepProb);
  //if the #1 receier is "juiced" or it the random deepProb integer is above 50, it is a big play
...
// j is y
      ...
      //this block moves the receiver and ball up the field "bigPlayYardage" amount of yards
...
//the entire team moves to the spot of the play, the field is redrawn, and the function ends
System.out.print("\033[H\033[2J");
System.out.flush();
System.out.println();
        System.out.println();
      ...
      //if deepProb is less than 50, it is either an imcompletion or interception, 50/50 chance
    else if (deepProb<50){
        ...
        if(f==1){
          ...
          //if its an interception, the team is reset to their origional positions and the other team takes over
    a.roster()[0].setX(19);
    a.roster()[1].setX(18);
    a.roster()[2].setX(18);
    a.roster()[3].setX(18);
...
System.out.flush();
  ...
  //the next two input types (2 for Medium Pass, 3 for screen pass) use the same moving/drawing functions. The only difference between the three is the odds of a big play/small play/incompletion or turnover happening 
...
// DEFENSE, Linebackers
     else if(i == a.roster()[0].getX()-4 && j==a.roster()[0].getY()){
      
        System.out.print(RED+"X");
       if(a.roster()[0].getX()-4<4){
      ...
      else if(i == a.roster()[4].getX()-4 && j==a.roster()[4].getY()){
       System.out.print(RED+"X");
       if(a.roster()[4].getX()-4<4){
         System.out.print(YELLOW+"■");
       }
       else{
       System.out.print(GREEN+"■");}
      ...
      //te = 18,9
    else if(i==a.roster()[5].getX()-2 && j==a.roster()[5].getY()){
        System.out.print(RED+"X");
...
System.out.println("You're the coach of the "+ a.teamName() + ": \n1.Run\n2.Pass\n3.Trick Play (If you're feeling bold)");
